# Generated by Django 3.1.6 on 2021-03-08 09:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('S', 'Clothing'), ('SW', 'Mobile'), ('OW', 'Automobile')], max_length=2)),
                ('lebel', models.CharField(choices=[('P', 'primary'), ('S', 'secondary'), ('D', 'danger')], max_length=1)),
        ...
        migrations.AddField(
            model_name='order',
            name='orderitem',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='order_item', to='core.orderitem'),
        ),
        migrations.AddField(
            model_name='order',
            name='payment',
